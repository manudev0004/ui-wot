  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">WoT UI Generator</h1>
        <p className="text-lg text-gray-600 mb-8">Create dynamic user interfaces from Thing Descriptions</p>
        <div className="text-gray-500">Click the + button to get started</div>
      </div>
