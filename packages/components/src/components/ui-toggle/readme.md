...
| `mqttTopic` | `mqtt-topic` | MQTT topic path for MQTT protocol (e.g., "device/toggle")                                                                                                                                                                                                                                                      | `string`                                               | `undefined`   |
| `onChange`  | `on-change`  | Function name to call when toggle state changes (for local control). User defines this function in their code, component will invoke it.                                                                                                                                                                       | `string`                                               | `undefined`   |
