...
| `disabled`    | `disabled`    | Whether the text component is disabled.                                                                                                                                                                                                | `boolean`                                                   | `false`          |
...
| ------------ | -------------------------------------- | ------------------------------------------------- |
| `textChange` | Event emitted when text value changes. | `CustomEvent<{ value: string; label?: string; }>` |
